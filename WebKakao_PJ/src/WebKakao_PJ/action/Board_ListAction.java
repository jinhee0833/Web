...
public class Board_ListAction extends HttpServlet {
	...
	protected void doUser(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<h1>InsertAction.java</h1> <br>");
		Boolean bool = true;
		...
		RequestDispatcher dis = request.getRequestDispatcher("Story_List1.jsp");
