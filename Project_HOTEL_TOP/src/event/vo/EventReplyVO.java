...
public class EventReplyVO { //bridge
	private int 	r_num;	//댓글번호 seq
	private int 	num;	//참조글번호
	...
	public java.util.Date getR_sdate() {
		return r_sdate;
	}
	public void setR_sdate(java.util.Date r_sdate) {
