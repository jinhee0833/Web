...
<script language = "javascript">
	function goDel(r_num){
		window.open("./event/G_replyDelete.jsp?r_num="+r_num,"Delete","width=350, height=100");
	}
...
<body>
	<form name=reply method=post action=event/G_replyInsert.jsp onsubmit="return check()">
	<input type=hidden name=num value= <%= request.getParameter("num") %>>
		...
		<tr>
			<td colspan=3>
			<textarea name=r_content class="ta2"></textarea>
			</td>
		</tr>	
		</table>	
	</form>
...
%>	
		<table class="event_commentF">		
			...
			<input type=button onclick="goDel(<%= bean2.getR_num() %>)" value="삭제" class="bt2"></td>
			</tr>
			<tr>
